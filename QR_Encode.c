...
#if MAX_QR_VERSION >= QR_VERSION_S
	INIT_QR_VERSION(4, // Ver.4,
		100, 80, 64, 48, 36, 1, 26, 0, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(1, 100, 80), INIT_RS_BLOCK(2, 50, 32),  INIT_RS_BLOCK(2, 50, 24),  INIT_RS_BLOCK(4, 25, 9),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(0, 0, 0)),
	INIT_QR_VERSION(5, // Ver.5,
		134, 108, 86, 62, 46, 1, 30, 0, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(1, 134, 108), INIT_RS_BLOCK(2, 67, 43),  INIT_RS_BLOCK(2, 33, 15),  INIT_RS_BLOCK(2, 33, 11),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(2, 34, 16),  INIT_RS_BLOCK(2, 34, 12)),
	INIT_QR_VERSION(6, // Ver.6,
		172, 136, 108, 76, 60, 1, 34, 0, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 86, 68), INIT_RS_BLOCK(4, 43, 27),  INIT_RS_BLOCK(4, 43, 19),  INIT_RS_BLOCK(4, 43, 15),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(0, 0, 0)),
	INIT_QR_VERSION(7, // Ver.7,
		196, 156, 124, 88, 66, 2, 22, 38, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 98, 78), INIT_RS_BLOCK(4, 49, 31),  INIT_RS_BLOCK(2, 32, 14),  INIT_RS_BLOCK(4, 39, 13),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(4, 33, 15),  INIT_RS_BLOCK(1, 40, 14)),
	INIT_QR_VERSION(8, // Ver.8,
		242, 194, 154, 110, 86, 2, 24, 42, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 121, 97), INIT_RS_BLOCK(2, 60, 38),  INIT_RS_BLOCK(4, 40, 18),  INIT_RS_BLOCK(4, 40, 14),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(2, 61, 39),  INIT_RS_BLOCK(2, 41, 19),  INIT_RS_BLOCK(2, 41, 15)),
	INIT_QR_VERSION(9, // Ver.9,
		292, 232, 182, 132, 100, 2, 26, 46, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 146, 116), INIT_RS_BLOCK(3, 58, 36),  INIT_RS_BLOCK(4, 36, 16),  INIT_RS_BLOCK(4, 36, 12),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(2, 59, 37),  INIT_RS_BLOCK(4, 37, 17),  INIT_RS_BLOCK(4, 37, 13)),
#endif  // #if MAX_QR_VERSION >= QR_VERSION_S

#if MAX_QR_VERSION >= QR_VERSION_M
	INIT_QR_VERSION(10, // Ver.10,
		346, 274, 216, 154, 122, 2, 28, 50, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 86, 68), INIT_RS_BLOCK(4, 69, 43),  INIT_RS_BLOCK(6, 43, 19),  INIT_RS_BLOCK(6, 43, 15),
		INIT_RS_BLOCK_INFO(2, 87, 69), INIT_RS_BLOCK(1, 70, 44),  INIT_RS_BLOCK(2, 44, 20),  INIT_RS_BLOCK(2, 44, 16)),
	INIT_QR_VERSION(11, // Ver.11,
		404, 324, 254, 180, 140, 2, 30, 54, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(4, 101, 81), INIT_RS_BLOCK(1, 80, 50),  INIT_RS_BLOCK(4, 50, 22),  INIT_RS_BLOCK(3, 36, 12),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(4, 81, 51),  INIT_RS_BLOCK(4, 51, 23),  INIT_RS_BLOCK(8, 37, 13)),
	INIT_QR_VERSION(12, // Ver.12,
		466, 370, 290, 206, 158, 2, 32, 58, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(2, 116, 92), INIT_RS_BLOCK(6, 58, 36),  INIT_RS_BLOCK(4, 46, 20),  INIT_RS_BLOCK(7, 42, 14),
		INIT_RS_BLOCK_INFO(2, 117, 93), INIT_RS_BLOCK(2, 59, 37),  INIT_RS_BLOCK(6, 47, 21),  INIT_RS_BLOCK(4, 43, 15)),
	INIT_QR_VERSION(13, // Ver.13,
		532, 428, 334, 244, 180, 2, 34, 62, 0, 0, 0, 0
		INIT_RS_BLOCK_INFO(4, 133, 107), INIT_RS_BLOCK(8, 59, 37),  INIT_RS_BLOCK(8, 44, 20),  INIT_RS_BLOCK(12, 33, 11),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(1, 60, 38),  INIT_RS_BLOCK(4, 45, 21),  INIT_RS_BLOCK(4, 34, 12)),
	INIT_QR_VERSION(14, // Ver.14,
		581, 461, 365, 261, 197, 3, 26, 46, 66, 0, 0, 0
		INIT_RS_BLOCK_INFO(3, 145, 115), INIT_RS_BLOCK(4, 64, 40),  INIT_RS_BLOCK(11, 36, 16),  INIT_RS_BLOCK(11, 36, 12),
		INIT_RS_BLOCK_INFO(1, 146, 116), INIT_RS_BLOCK(5, 65, 41),  INIT_RS_BLOCK(5, 37, 17),  INIT_RS_BLOCK(5, 37, 13)),
	INIT_QR_VERSION(15, // Ver.15,
		655, 523, 415, 295, 223, 3, 26, 48, 70, 0, 0, 0
		INIT_RS_BLOCK_INFO(5, 109, 87), INIT_RS_BLOCK(5, 65, 41),  INIT_RS_BLOCK(5, 54, 24),  INIT_RS_BLOCK(11, 36, 12),
		INIT_RS_BLOCK_INFO(1, 110, 88), INIT_RS_BLOCK(5, 66, 42),  INIT_RS_BLOCK(7, 55, 25),  INIT_RS_BLOCK(7, 37, 13)),
	INIT_QR_VERSION(16, // Ver.16,
		733, 589, 453, 325, 253, 3, 26, 50, 74, 0, 0, 0
		INIT_RS_BLOCK_INFO(5, 122, 98), INIT_RS_BLOCK(7, 73, 45),  INIT_RS_BLOCK(15, 43, 19),  INIT_RS_BLOCK(3, 45, 15),
		INIT_RS_BLOCK_INFO(1, 123, 99), INIT_RS_BLOCK(3, 74, 46),  INIT_RS_BLOCK(2, 44, 20),  INIT_RS_BLOCK(13, 46, 16)),
	INIT_QR_VERSION(17, // Ver.17,
		815, 647, 507, 367, 283, 3, 30, 54, 78, 0, 0, 0
		INIT_RS_BLOCK_INFO(1, 135, 107), INIT_RS_BLOCK(10, 74, 46),  INIT_RS_BLOCK(1, 50, 22),  INIT_RS_BLOCK(2, 42, 14),
		INIT_RS_BLOCK_INFO(5, 136, 108), INIT_RS_BLOCK(1, 75, 47),  INIT_RS_BLOCK(15, 51, 23),  INIT_RS_BLOCK(17, 43, 15)),
	INIT_QR_VERSION(18, // Ver.18,
		901, 721, 563, 397, 313, 3, 30, 56, 82, 0, 0, 0
		INIT_RS_BLOCK_INFO(5, 150, 120), INIT_RS_BLOCK(9, 69, 43),  INIT_RS_BLOCK(17, 50, 22),  INIT_RS_BLOCK(2, 42, 14),
		INIT_RS_BLOCK_INFO(1, 151, 121), INIT_RS_BLOCK(4, 70, 44),  INIT_RS_BLOCK(1, 51, 23),  INIT_RS_BLOCK(19, 43, 15)),
	INIT_QR_VERSION(19, // Ver.19,
		991, 795, 627, 445, 341, 3, 30, 58, 86, 0, 0, 0
		INIT_RS_BLOCK_INFO(3, 141, 113), INIT_RS_BLOCK(3, 70, 44),  INIT_RS_BLOCK(17, 47, 21),  INIT_RS_BLOCK(9, 39, 13),
		INIT_RS_BLOCK_INFO(4, 142, 114), INIT_RS_BLOCK(11, 71, 45),  INIT_RS_BLOCK(4, 48, 22),  INIT_RS_BLOCK(16, 40, 14)),
	INIT_QR_VERSION(20, // Ver.20,
		1085, 861, 669, 485, 385, 3, 34, 62, 90, 0, 0, 0
		INIT_RS_BLOCK_INFO(3, 135, 107), INIT_RS_BLOCK(3, 67, 41),  INIT_RS_BLOCK(15, 54, 24),  INIT_RS_BLOCK(15, 43, 15),
		INIT_RS_BLOCK_INFO(5, 136, 108), INIT_RS_BLOCK(13, 68, 42),  INIT_RS_BLOCK(5, 55, 25),  INIT_RS_BLOCK(10, 44, 16)),
	INIT_QR_VERSION(21, // Ver.21,
		1156, 932, 714, 512, 406, 4, 28, 50, 72, 94, 0, 0
		INIT_RS_BLOCK_INFO(4, 144, 116), INIT_RS_BLOCK(17, 68, 42),  INIT_RS_BLOCK(17, 50, 22),  INIT_RS_BLOCK(19, 46, 16),
		INIT_RS_BLOCK_INFO(4, 145, 117), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(6, 51, 23),  INIT_RS_BLOCK(6, 47, 17)),
	INIT_QR_VERSION(22, // Ver.22,
		1258, 1006, 782, 568, 442, 4, 26, 50, 74, 98, 0, 0
		INIT_RS_BLOCK_INFO(2, 139, 111), INIT_RS_BLOCK(17, 74, 46),  INIT_RS_BLOCK(7, 54, 24),  INIT_RS_BLOCK(34, 37, 13),
		INIT_RS_BLOCK_INFO(7, 140, 112), INIT_RS_BLOCK(0, 0, 0),  INIT_RS_BLOCK(16, 55, 25),  INIT_RS_BLOCK(0, 0, 0)),
	INIT_QR_VERSION(23, // Ver.23,
		1364, 1094, 860, 614, 464, 4, 30, 54, 78, 102, 0, 0
		INIT_RS_BLOCK_INFO(4, 151, 121), INIT_RS_BLOCK(4, 75, 47),  INIT_RS_BLOCK(11, 54, 24),  INIT_RS_BLOCK(16, 45, 15),
		INIT_RS_BLOCK_INFO(5, 152, 122), INIT_RS_BLOCK(14, 76, 48),  INIT_RS_BLOCK(14, 55, 25),  INIT_RS_BLOCK(14, 46, 16)),
	INIT_QR_VERSION(24, // Ver.24,
		1474, 1174, 914, 664, 514, 4, 28, 54, 80, 106, 0, 0
		INIT_RS_BLOCK_INFO(6, 147, 117), INIT_RS_BLOCK(6, 73, 45),  INIT_RS_BLOCK(11, 54, 24),  INIT_RS_BLOCK(30, 46, 16),
		INIT_RS_BLOCK_INFO(4, 148, 118), INIT_RS_BLOCK(14, 74, 46),  INIT_RS_BLOCK(16, 55, 25),  INIT_RS_BLOCK(2, 47, 17)),
	INIT_QR_VERSION(25, // Ver.25,
		1588, 1276, 1000, 718, 538, 4, 32, 58, 84, 110, 0, 0
		INIT_RS_BLOCK_INFO(8, 132, 106), INIT_RS_BLOCK(8, 75, 47),  INIT_RS_BLOCK(7, 54, 24),  INIT_RS_BLOCK(22, 45, 15),
		INIT_RS_BLOCK_INFO(4, 133, 107), INIT_RS_BLOCK(13, 76, 48),  INIT_RS_BLOCK(22, 55, 25),  INIT_RS_BLOCK(13, 46, 16)),
	INIT_QR_VERSION(26, // Ver.26,
		1706, 1370, 1062, 754, 596, 4, 30, 58, 86, 114, 0, 0
		INIT_RS_BLOCK_INFO(10, 142, 114), INIT_RS_BLOCK(19, 74, 46),  INIT_RS_BLOCK(28, 50, 22),  INIT_RS_BLOCK(33, 46, 16),
		INIT_RS_BLOCK_INFO(2, 143, 115), INIT_RS_BLOCK(4, 75, 47),  INIT_RS_BLOCK(6, 51, 23),  INIT_RS_BLOCK(4, 47, 17)),
#endif  // MAX_QR_VERSION >= QR_VERSION_M

#if MAX_QR_VERSION >= QR_VERSION_L
	INIT_QR_VERSION(27, // Ver.27,
		1828, 1468, 1128, 808, 628, 4, 34, 62, 90, 118, 0, 0
		INIT_RS_BLOCK_INFO(8, 152, 122), INIT_RS_BLOCK(22, 73, 45),  INIT_RS_BLOCK(8, 53, 23),  INIT_RS_BLOCK(12, 45, 15),
		INIT_RS_BLOCK_INFO(4, 153, 123), INIT_RS_BLOCK(3, 74, 46),  INIT_RS_BLOCK(26, 54, 24),  INIT_RS_BLOCK(28, 46, 16)),
	INIT_QR_VERSION(28, // Ver.28,
		1921, 1531, 1193, 871, 661, 5, 26, 50, 74, 98, 122, 0
		INIT_RS_BLOCK_INFO(3, 147, 117), INIT_RS_BLOCK(3, 73, 45),  INIT_RS_BLOCK(4, 54, 24),  INIT_RS_BLOCK(11, 45, 15),
		INIT_RS_BLOCK_INFO(10, 148, 118), INIT_RS_BLOCK(23, 74, 46),  INIT_RS_BLOCK(31, 55, 25),  INIT_RS_BLOCK(31, 46, 16)),
	INIT_QR_VERSION(29, // Ver.29,
		2051, 1631, 1267, 911, 701, 5, 30, 54, 78, 102, 126, 0
		INIT_RS_BLOCK_INFO(7, 146, 116), INIT_RS_BLOCK(21, 73, 45),  INIT_RS_BLOCK(1, 53, 23),  INIT_RS_BLOCK(19, 45, 15),
		INIT_RS_BLOCK_INFO(7, 147, 117), INIT_RS_BLOCK(7, 74, 46),  INIT_RS_BLOCK(37, 54, 24),  INIT_RS_BLOCK(26, 46, 16)),
	INIT_QR_VERSION(30, // Ver.30,
		2185, 1735, 1373, 985, 745, 5, 26, 52, 78, 104, 130, 0
		INIT_RS_BLOCK_INFO(5, 145, 115), INIT_RS_BLOCK(19, 75, 47),  INIT_RS_BLOCK(15, 54, 24),  INIT_RS_BLOCK(23, 45, 15),
		INIT_RS_BLOCK_INFO(10, 146, 116), INIT_RS_BLOCK(10, 76, 48),  INIT_RS_BLOCK(25, 55, 25),  INIT_RS_BLOCK(25, 46, 16)),
	INIT_QR_VERSION(31, // Ver.31,
		2323, 1843, 1455, 1033, 793, 5, 30, 56, 82, 108, 134, 0
		INIT_RS_BLOCK_INFO(13, 145, 115), INIT_RS_BLOCK(2, 74, 46),  INIT_RS_BLOCK(42, 54, 24),  INIT_RS_BLOCK(23, 45, 15),
		INIT_RS_BLOCK_INFO(3, 146, 116), INIT_RS_BLOCK(29, 75, 47),  INIT_RS_BLOCK(1, 55, 25),  INIT_RS_BLOCK(28, 46, 16)),
	INIT_QR_VERSION(32, // Ver.32,
		2465, 1955, 1541, 1115, 845, 5, 34, 60, 86, 112, 138, 0
		INIT_RS_BLOCK_INFO(17, 145, 115), INIT_RS_BLOCK(10, 74, 46),  INIT_RS_BLOCK(10, 54, 24),  INIT_RS_BLOCK(19, 45, 15),
		INIT_RS_BLOCK_INFO(0, 0, 0), INIT_RS_BLOCK(23, 75, 47),  INIT_RS_BLOCK(35, 55, 25),  INIT_RS_BLOCK(35, 46, 16)),
	INIT_QR_VERSION(33, // Ver.33,
		2611, 2071, 1631, 1171, 901, 5, 30, 58, 86, 114, 142, 0
		INIT_RS_BLOCK_INFO(17, 145, 115), INIT_RS_BLOCK(14, 74, 46),  INIT_RS_BLOCK(29, 54, 24),  INIT_RS_BLOCK(11, 45, 15),
		INIT_RS_BLOCK_INFO(1, 146, 116), INIT_RS_BLOCK(21, 75, 47),  INIT_RS_BLOCK(19, 55, 25),  INIT_RS_BLOCK(46, 46, 16)),
	INIT_QR_VERSION(34, // Ver.34,
		2761, 2191, 1725, 1231, 961, 5, 34, 62, 90, 118, 146, 0
		INIT_RS_BLOCK_INFO(13, 145, 115), INIT_RS_BLOCK(14, 74, 46),  INIT_RS_BLOCK(44, 54, 24),  INIT_RS_BLOCK(59, 46, 16),
		INIT_RS_BLOCK_INFO(6, 146, 116), INIT_RS_BLOCK(23, 75, 47),  INIT_RS_BLOCK(7, 55, 25),  INIT_RS_BLOCK(1, 47, 17)),
	INIT_QR_VERSION(35, // Ver.35,
		2876, 2306, 1812, 1286, 986, 6, 30, 54, 78, 102, 126, 150
		INIT_RS_BLOCK_INFO(12, 151, 121), INIT_RS_BLOCK(12, 75, 47),  INIT_RS_BLOCK(39, 54, 24),  INIT_RS_BLOCK(22, 45, 15),
		INIT_RS_BLOCK_INFO(7, 152, 122), INIT_RS_BLOCK(26, 76, 48),  INIT_RS_BLOCK(14, 55, 25),  INIT_RS_BLOCK(41, 46, 16)),
	INIT_QR_VERSION(36, // Ver.36,
		3034, 2434, 1914, 1354, 1054, 6, 24, 50, 76, 102, 128, 154
		INIT_RS_BLOCK_INFO(6, 151, 121), INIT_RS_BLOCK(6, 75, 47),  INIT_RS_BLOCK(46, 54, 24),  INIT_RS_BLOCK(2, 45, 15),
		INIT_RS_BLOCK_INFO(14, 152, 122), INIT_RS_BLOCK(34, 76, 48),  INIT_RS_BLOCK(10, 55, 25),  INIT_RS_BLOCK(64, 46, 16)),
	INIT_QR_VERSION(37, // Ver.37,
		3196, 2566, 1992, 1426, 1096, 6, 28, 54, 80, 106, 132, 158
		INIT_RS_BLOCK_INFO(17, 152, 122), INIT_RS_BLOCK(29, 74, 46),  INIT_RS_BLOCK(49, 54, 24),  INIT_RS_BLOCK(24, 45, 15),
		INIT_RS_BLOCK_INFO(4, 153, 123), INIT_RS_BLOCK(14, 75, 47),  INIT_RS_BLOCK(10, 55, 25),  INIT_RS_BLOCK(46, 46, 16)),
	INIT_QR_VERSION(38, // Ver.38,
		3362, 2702, 2102, 1502, 1142, 6, 32, 58, 84, 110, 136, 162
		INIT_RS_BLOCK_INFO(4, 152, 122), INIT_RS_BLOCK(13, 74, 46),  INIT_RS_BLOCK(48, 54, 24),  INIT_RS_BLOCK(42, 45, 15),
		INIT_RS_BLOCK_INFO(18, 153, 123), INIT_RS_BLOCK(32, 75, 47),  INIT_RS_BLOCK(14, 55, 25),  INIT_RS_BLOCK(32, 46, 16)),
	INIT_QR_VERSION(39, // Ver.39,
		3532, 2812, 2216, 1582, 1222, 6, 26, 54, 82, 110, 138, 166
		INIT_RS_BLOCK_INFO(20, 147, 117), INIT_RS_BLOCK(40, 75, 47),  INIT_RS_BLOCK(43, 54, 24),  INIT_RS_BLOCK(10, 45, 15),
		INIT_RS_BLOCK_INFO(4, 148, 118), INIT_RS_BLOCK(7, 76, 48),  INIT_RS_BLOCK(22, 55, 25),  INIT_RS_BLOCK(67, 46, 16)),
	INIT_QR_VERSION(40, // Ver.40,
		3706, 2956, 2334, 1666, 1276, 6, 30, 58, 86, 114, 142, 170
		INIT_RS_BLOCK_INFO(19, 148, 118), INIT_RS_BLOCK(18, 75, 47),  INIT_RS_BLOCK(34, 54, 24),  INIT_RS_BLOCK(20, 45, 15),
		INIT_RS_BLOCK_INFO(6, 149, 119), INIT_RS_BLOCK(31, 76, 48),  INIT_RS_BLOCK(34, 55, 25),  INIT_RS_BLOCK(61, 46, 16)),
#endif  // MAX_QR_VERSION >= QR_VERSION_L
};
...
int GetEncodeVersion(int nVersion, LPCSTR lpsSource, int ncLength,int m_nBlockLength[MAX_DATACODEWORD],BYTE m_byBlockMode[MAX_DATACODEWORD],BYTE m_byDataCodeWord[MAX_DATACODEWORD])
{
	...
	for (i = nVerGroup; i <= MAX_QR_VERSION; ++i)
	{
